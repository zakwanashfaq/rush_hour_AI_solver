...
namespace utils {
	...
	bool isLegalAction();
	bool movePlayerUp(std::shared_ptr<stateNode> node);
	bool movePlayerDown(std::shared_ptr<stateNode> node);
	...
	std::string getNodeEncoding(std::shared_ptr<stateNode> node);
